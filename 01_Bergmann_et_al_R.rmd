...
Content: This R Markdown document includes the majority of 'Age-related increase in neurofilament light in blood among mammalian species' analyses - German Center for Neurodegenerative Diseases (DZNE) e.V. Tübingen & Hertie Institute for Clinical Brain Research - Department of Cellular Neuroscience - AG Jucker
...
for (pkg in packages) {
  if (!require(pkg, character.only = TRUE)) {
    message(paste0("📦 ", pkg, " is installed…"))
    install.packages(pkg, dependencies = TRUE)
  }
  message(paste0("✅ ", pkg, "is loaded"))
...
# Upload Excel file
NfL_Species <- read_excel("/Users/carinabergmann_1/Documents/01-Carina_PhD/28-NfL-Species-Paper/19-DATA/00-Bergmann_et_al.xlsx")
...
options(contrasts = c("contr.sum", "contr.poly"))  # wichtig für Type III
